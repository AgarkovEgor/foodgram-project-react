...
from recipe.models import Recipe, Ingredient, Tag, IngredientRecipe, Favorite, ShoppingCart
...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        fields = ('id', 'tags', 'author', 'ingredients','image', 'name', 'text', 'cooking_time','is_favorite','is_in_shopping_cart')
        model = Recipe
